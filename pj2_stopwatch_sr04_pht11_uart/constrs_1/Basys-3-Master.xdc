...
##Pmod Header JA
set_property -dict { PACKAGE_PIN J1   IOSTANDARD LVCMOS33 } [get_ports echo];#Sch name = JA1 ## echo
set_property -dict { PACKAGE_PIN L2   IOSTANDARD LVCMOS33 } [get_ports trig];#Sch name = JA2 ## trig
set_property -dict { PACKAGE_PIN J2   IOSTANDARD LVCMOS33 } [get_ports dht11];#Sch name = JA3 ## dht11
